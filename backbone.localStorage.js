...
// window.Store is deprectated, use Backbone.LocalStorage instead
  Backbone.LocalStorage = window.Store = function(name, serializer,collectionBound) {
    ...
    console.log('calling backbone local storage constructor');
    this.collection = collectionBound;
    this.collection.prototype.sync = this.collection.prototype.model.prototype.sync = Backbone.localSync;
    this.name = name;
